...
<p>想像你正在雜貨店中購物，穿梭在貨架間，邊將需要的商品放入購物籃中。你拿了一些鮮食、乳製品、冷凍食品以及罐頭。如果你想列出每個貨品來自於哪個貨架，這些資料將屬於標稱型。"nominal"這個單字來自於拉丁文中的"nomen"，意思是"關於名稱的"。因為此種資料型態由資料屬於哪種分類所組成，我們稱此為標稱型資料。標稱型資料是無序的，如我們不能將一個產品的分類與奶製品做數學上大小的比較。</p>
